// ABOUTME: Displays operational analytics including P&L summary, month-over-month comparison, and cash flow forecasting.
// ABOUTME: Handles query state, loading indicators, error banners, and export action buttons for daily operations.
...
import { Receipt, BarChart3, TrendingUp, TrendingDown, PieChart, ArrowUpRight, ArrowDownRight, AlertTriangle, Target, Wallet, Download, FileSpreadsheet, Smartphone, TrendingDown as ExpensesIcon, Plus } from "lucide-react";
    ...
    <div className="space-y-6">
        ...
        <Card className="border-gray-200">
          <CardHeader className="pb-3">
            <CardTitle className="font-serif text-lg flex items-center gap-2">
              <BarChart3 className="h-5 w-5 text-orange-600" /> Month-over-Month Comparison
            </CardTitle>
          </CardHeader>
          <CardContent>
      ...
      <Card className="border-gray-200">
        <CardHeader className="pb-3 flex flex-row items-center justify-between">
          <CardTitle className="font-serif text-lg flex items-center gap-2">
            <Target className="h-5 w-5 text-orange-600" /> Food Cost Analysis
          </CardTitle>
