      ...
      <section className="border-t border-[#E8E0D8] bg-[#F5EDE6] py-16">
        <div className="mx-auto max-w-3xl px-4 text-center">
          ...
          <p className="mt-3 text-sm text-[#8D8A87]">
            Join our Partner Program and earn <strong className="text-[#D4A854]">20% revenue share</strong> from every restaurant client you onboard. Manage all your clients from one dashboard.
          </p>
